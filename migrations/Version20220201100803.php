...
final class Version20220201100803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE race ADD is_for_adults TINYINT(1) DEFAULT NULL, ADD is_for_youngs TINYINT(1) DEFAULT NULL');
    }
